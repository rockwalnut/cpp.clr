    ...
    /* [out] */ EPICallStatus *peCallStatus)
{
    ...
    NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &PiServerConnect__MIDL_ProcFormatString.Format[0],
                  ( unsigned char * )&hdl);
    ...
    /* [out] */ EPICallStatus *peCallStatus)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&PISerConnectInterface_StubDesc,
                  (PFORMAT_STRING) &PiServerConnect__MIDL_ProcFormatString.Format[70],
    ...
    /* [out] */ EPICallStatus *peCallStatus)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&PISerConnectInterface_StubDesc,
                  (PFORMAT_STRING) &PiServerConnect__MIDL_ProcFormatString.Format[118],
                  ( unsigned char * )&phContext);
    ...
    /* [out] */ long *lSchema)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&PISerConnectInterface_StubDesc,
                  (PFORMAT_STRING) &PiServerConnect__MIDL_ProcFormatString.Format[166],
                  ( unsigned char * )&phContext);
    ...
    /* [out] */ EPIMachineType *eMachineType)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&PISerConnectInterface_StubDesc,
                  (PFORMAT_STRING) &PiServerConnect__MIDL_ProcFormatString.Format[226],
                  ( unsigned char * )&phContext);
