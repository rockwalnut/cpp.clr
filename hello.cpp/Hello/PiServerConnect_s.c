...
/* at Tue Jan 10 12:16:06 2017
 */
/* Compiler settings for PiServerConnect.idl:
...
typedef struct _PiServerConnect_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } PiServerConnect_MIDL_TYPE_FORMAT_STRING;

typedef struct _PiServerConnect_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } PiServerConnect_MIDL_PROC_FORMAT_STRING;

typedef struct _PiServerConnect_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } PiServerConnect_MIDL_EXPR_FORMAT_STRING;


static const RPC_SYNTAX_IDENTIFIER  _RpcTransferSyntax = 
{{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}};

extern const PiServerConnect_MIDL_TYPE_FORMAT_STRING PiServerConnect__MIDL_TypeFormatString;
extern const PiServerConnect_MIDL_PROC_FORMAT_STRING PiServerConnect__MIDL_ProcFormatString;
extern const PiServerConnect_MIDL_EXPR_FORMAT_STRING PiServerConnect__MIDL_ExprFormatString;

/* Standard interface: PISerConnectInterface, ver. 1.0,
   GUID={0x55da2909,0x0843,0x4e35,{0xa2,0xd4,0x29,0x03,0x62,0x9c,0x3c,0x98}} */


extern const MIDL_SERVER_INFO PISerConnectInterface_ServerInfo;

extern const RPC_DISPATCH_TABLE PISerConnectInterface_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE PISerConnectInterface___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x55da2909,0x0843,0x4e35,{0xa2,0xd4,0x29,0x03,0x62,0x9c,0x3c,0x98}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&PISerConnectInterface_v1_0_DispatchTable,
    0,
    0,
    0,
    &PISerConnectInterface_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE PISerConnectInterface_v1_0_s_ifspec = (RPC_IF_HANDLE)& PISerConnectInterface___RpcServerInterface;
...
static const PiServerConnect_MIDL_PROC_FORMAT_STRING PiServerConnect__MIDL_ProcFormatString =
    {
        0,
        {

	/* Procedure RpcBMConnect */
...
static const PiServerConnect_MIDL_TYPE_FORMAT_STRING PiServerConnect__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUB_DESC PISerConnectInterface_StubDesc = 
    {
    (void *)& PISerConnectInterface___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    RundownRoutines,
    ...
    0,
    0,
    PiServerConnect__MIDL_TypeFormatString.Format,
...
static const RPC_DISPATCH_FUNCTION PISerConnectInterface_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE PISerConnectInterface_v1_0_DispatchTable = 
    {
    5,
    (RPC_DISPATCH_FUNCTION*)PISerConnectInterface_table
    };

static const SERVER_ROUTINE PISerConnectInterface_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)RpcBMConnect,
    (SERVER_ROUTINE)RpcBMDisconnect,
    (SERVER_ROUTINE)RpcBMPing,
    (SERVER_ROUTINE)RpcBMGetVersionInfo,
    (SERVER_ROUTINE)RpcBMGetMachineInfo
    };

static const MIDL_SERVER_INFO PISerConnectInterface_ServerInfo = 
    {
    &PISerConnectInterface_StubDesc,
    PISerConnectInterface_ServerRoutineTable,
    PiServerConnect__MIDL_ProcFormatString.Format,
    PISerConnectInterface_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
