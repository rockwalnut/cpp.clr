...
extern const MIDL_SERVER_INFO PICliAlignInterface_ServerInfo;

extern const RPC_DISPATCH_TABLE PICliAlignInterface_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE PICliAlignInterface___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x5a97b60b,0x9972,0x4e6e,{0x81,0x80,0x4f,0xc9,0xc0,0x86,0x4c,0xb8}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&PICliAlignInterface_v1_0_DispatchTable,
    0,
    0,
    0,
    &PICliAlignInterface_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE PICliAlignInterface_v1_0_s_ifspec = (RPC_IF_HANDLE)& PICliAlignInterface___RpcServerInterface;
...
static const MIDL_STUB_DESC PICliAlignInterface_StubDesc = 
    {
    (void *)& PICliAlignInterface___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    RundownRoutines,
...
static const RPC_DISPATCH_FUNCTION PICliAlignInterface_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE PICliAlignInterface_v1_0_DispatchTable = 
    {
    4,
    (RPC_DISPATCH_FUNCTION*)PICliAlignInterface_table
    };

static const SERVER_ROUTINE PICliAlignInterface_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)RpcPIPostAlignData,
    (SERVER_ROUTINE)RpcPIPostRegistrationVerificationData,
    (SERVER_ROUTINE)RpcPICorrectionReceived,
    (SERVER_ROUTINE)RpcPIPostFidFoundData
    };

static const MIDL_SERVER_INFO PICliAlignInterface_ServerInfo = 
    {
    &PICliAlignInterface_StubDesc,
    PICliAlignInterface_ServerRoutineTable,
    PiClientAlign__MIDL_ProcFormatString.Format,
    PICliAlignInterface_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
